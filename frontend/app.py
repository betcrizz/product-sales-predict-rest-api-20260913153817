...
Store_Type = st.selectbox("Instantly Bookable?", ["Food Mart", "Departmental Store", "Supermarket Type1","Supermarket Type2"])
Product_Id_char = st.number_input("Review Score Rating")
...
input_data = pd.DataFrame([{
    ...
    'Store_Location_City_Type': Store_Location_City_Type,  # Convert to 't' or 'f'
